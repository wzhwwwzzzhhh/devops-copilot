...
| 界面 | 说明 |
|------|------|
| ![主界面](image/PixPin_2026-06-14_19-02-49.png) | 主聊天界面与 AI 诊断对话 |
| ![监控仪表盘](image/PixPin_2026-06-14_19-03-33.png) | 多维度监控仪表盘 |
| ![数据看板](image/PixPin_2026-06-14_19-09-00.png) | 数据库/Redis 实时监控看板 |
| ![配置管理](image/PixPin_2026-06-14_19-09-35.png) | 连接管理与系统配置 |
